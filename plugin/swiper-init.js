 ...
 */
export function parseSwiperClasses(element, customModules) {
    ...
    if (mousewheel)
        options.mousewheel = { forceToAxis: true };
 ...
 */
export function initTailwindSwipers(SwiperClass, modules) {
    if (!SwiperClass) {
